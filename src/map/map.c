...
void defaultMap(struct Map* Map) {
	...
	Map->array[1].description = "the North-Western Sleeping Quarter. A dark, dusty room.\n";
	Map->array[2].description = "the Western Sleeping Quarter. A big and colorful room full of items.\n";
	Map->array[3].description = "the Eastern Sleeping Quarter. There is blood on the bed sheets. At the corner of the room there is a box.\n"; //possibility to find items in this room
	Map->array[4].description = "the Eastern Common Room. Not much to see here except some fresh bizarre-looking footprints.\n";
	Map->array[5].description = "the Western Hall. A dark, eerie hall with creaky floorboards.\n"; //can be heard by monsters when walking here
	Map->array[6].description = "the Main Common Room. A large room filled with bookshelves, a couch, chairs and a table. A chair is knocked to the floor.\n"; //might find something in the bookshelves
	Map->array[7].description = "the Dinner Hall. A large room with a long table and many chairs. Leftovers and dirty dishes fill up the table. In the centre of it, something shiny can be seen.\n"; //a key can be found in this room
	Map->array[8].description = "the Kitchen. A rather small room with dark counters and dirty tiles and window.\n";
	Map->array[9].description = "the Terminal Room. A tiny, sultry room with a turned on CRT-monitor on a metal desk.\n";
	Map->array[10].description = "the South-Western Sleeping Quarter. A small room with only a bunk-bed and a closet.\n";
	Map->array[11].description = "the Southern Hall. A narrow, dark hall with a large crack in the floorboards.\n";
	Map->array[12].description = "the Eastern Dinner Hall. A room full of cabinets alongside the dinner table.\n";
	Map->array[13].description = "the Southern Common Room. A messy room with thrown books and other debris.\n";
	Map->array[14].description = "the South-Eastern Hall. A white and long hall with slippery tiles.\n";
	Map->array[15].description = "the South-Eastern Sleeping Quarter. A tidy room with a huge bed and a large closet.\n";
}
