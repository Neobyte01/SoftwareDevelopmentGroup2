...
void defaultMap(struct Map* Map) {
	...
	Map->array[5].description = "A dark, eerie hall with\ncreaky floorboards.\n"; //can be heard by monsters when walking here
	...
	Map->array[10].description = "A small room with only a bunk-bed and a closet.\n";
	Map->array[11].description = "A narrow, dark hall with a large crack in the floorboards.\n";
	Map->array[12].description = "A room full of cabinets alongside the dinner table.\n";
	Map->array[13].description = "A messy room with thrown books and other debris.\n";
	Map->array[14].description = "A white and long hall with slippery tiles.\n";
	Map->array[15].description = "A tidy room with a huge bed and a large closet.\n";
